...
"""autogenerated by genpy from kw_msgs/CarrotActionResult.msg. Do not edit."""
import codecs
import sys
...
class CarrotActionResult(genpy.Message):
  _md5sum = "caf70877fbd38929b3f3c42c34fa8110"
  _type = "kw_msgs/CarrotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kw_msgs/CarrotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CarrotActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kw_msgs.msg.CarrotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kw_msgs.msg.CarrotResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total,) = _get_struct_q().unpack(str[start:end])
      return self
